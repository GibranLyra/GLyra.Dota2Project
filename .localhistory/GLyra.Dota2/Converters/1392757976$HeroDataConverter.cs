...
namespace Dota.CentralDota.Converters
{
    class HeroDataConverter
    {
        ...
        Dictionary<string, Dictionary<string, string>> GetSkillRemainingValues(HtmlDocument doc, out List<string> skillDescriptions)
        {
            ...
            for (int i = 0; i < abilityFooterBoxRight.Count; i++)
			{
                ...
                if (divInnerHtml != null)
                {
                    ...
                    skillDescriptions.Add(getSkillDescriptionInRemainingSkill(abilityHeaderRowDescription[i]));
