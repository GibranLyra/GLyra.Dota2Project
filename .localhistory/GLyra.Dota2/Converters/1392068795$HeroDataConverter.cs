...
namespace Dota.CentralDota.Repositories
{
    class HeroDataConverter
    {
        ...
        string biography;
        Dictionary<string, string> manaCostDictionary = new Dictionary<string,<string>();
        ...
        Dictionary<string, string> GetManaCost(HtmlDocument doc)
        {
            var manaCostDictionary = new Dictionary<string, string>();
            ...
            foreach (var manaCost in mana)
            {
                ...
                manaCostDictionary.Add(skillName, manaCost.InnerText);
            }            
