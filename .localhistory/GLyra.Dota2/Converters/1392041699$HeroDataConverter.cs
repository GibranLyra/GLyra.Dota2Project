...
namespace Dota.CentralDota.Repositories
{
    class HeroDataConverter
    {
        ...
        public HeroDataConverter()
        {
            ...
            abilityCastType = GetSkillBehaviour(doc);
            ...
            //{
            //    createSkill(skillNames[i], skillDescriptions[i], manaCostList, coolDownList, )
            //}
        }
        ...
        {
            SkillCreator sCretor = new SkillCreator(name, description, manaCostList, coolDownList, abilityType, targetAffectedType, damageType, videoUrl);
        }
