...
namespace Dota.CentralDota.Converters
{
    class HeroDataConverter
    {
        ...
        protected void createSkillImage()
        {
        ...
        protected void createSkill()
        {
            ...
            {
                Skill skill = heroCreator.createHeroSkill(skillNames[i], skillDescriptions[i], manaCostDictionary, coolDownList, abilityCastType,
