...
namespace GLyra.Dota2.Converters
{
    public class SkillCreator
    {
            ...
            List<string> abilityCastType, List<string> targetAffectedType, List<string> damageType, string videoUrl)
        {
            ...
            setManaCost(manaCostList);
            setCoolDowns(coolDownList);
        ...
        void setCoolDowns(string coolDownString)
        {
            ...
            this.skill.CoolDownLv1 = int.Parse(coolDowns.First());
            this.skill.CoolDownLv2 = int.Parse(coolDowns.ElementAt(1));
            this.skill.CoolDownLv3 = int.Parse(coolDowns.ElementAt(2));
            this.skill.CoolDownLv4 = int.Parse(coolDowns.ElementAt(3));
        }
