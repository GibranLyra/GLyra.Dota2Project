...
namespace GLyra.Dota2.Converters
{
    public class SkillCreator
    {
        ...
        void setManaCost(List<string> manaCostList)
        {
            ...
            this.skill.CoolDownLv2 = int.Parse(manaCostList.ElementAt(1));
            this.skill.CoolDownLv3 = int.Parse(manaCostList.ElementAt(2));
            this.skill.CoolDownLv4 = int.Parse(manaCostList.ElementAt(3));
        }
