...
namespace Dota.CentralDota.Converters
{
	internal class HeroDataConverter
	{
        ...
        private List<string> GetSkillPortraits()
        {
            ...
            var heroesIconHolder2 = doc.DocumentNode.SelectNodes("//*[(@class = 'abilityIconHolder2')]");

            heroesPortraitsUrlsList = agilityPackHelper.GetImageUrls(heroesIconHolder2, "abilityIconHolder2", expectedSize);
