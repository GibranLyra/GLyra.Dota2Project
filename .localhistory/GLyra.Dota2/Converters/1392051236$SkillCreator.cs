...
namespace GLyra.Dota2.Converters
{
    public class SkillCreator
    {
        ...
        void setCoolDowns(string coolDownString)
        {
            ...
            this.skill.CoolDownLv1 = decimal.TryParse(coolDowns.First());
            this.skill.CoolDownLv2 = decimal.TryParse(coolDowns.ElementAt(1));
            this.skill.CoolDownLv3 = decimal.TryParse(coolDowns.ElementAt(2));
            this.skill.CoolDownLv4 = decimal.TryParse(coolDowns.ElementAt(3));
        }
