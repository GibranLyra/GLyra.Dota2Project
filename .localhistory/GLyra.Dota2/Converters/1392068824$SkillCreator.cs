...
namespace GLyra.Dota2.Converters
{
    public class SkillCreator
    {
        ...
        public Skill createSkill(int heroId, string name, string description, Dictionary<string, List<string>> manaCostList, List<string> coolDownList,
            string abilityCastType, string targetAffectedType, string damageType, string videoUrl)
        {
            ...
            //Set Up ManaCost
            foreach (var manaCost in manaCostList.Values)
            {
