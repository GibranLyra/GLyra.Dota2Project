...
namespace Dota.CentralDota.Repositories
{
    class HeroDataConverter
    {
        ...
        List<string> skillVideos = new List<string>();
        ...
        public HeroDataConverter()
        {
            ...
            {
                heroCreator.createHeroSkills(skillNames[i], skillDescriptions[i], manaCostList, coolDownList, abilityCastType[i], skillTargetAffectedType[i], skillDamageType[i], skillVideos.First());
            }
        }
            
        void createHero(string name, string biography)
        {
